...
<html>
<head>
  <title>${REPORT_TYPE_LABELS[reportType] || 'Report'} - ${pharmacyName}</title>
  <style>
    * { box-sizing: border-box; }
    ...
    .doc-title { font-size: 1.1rem; font-weight: 600; margin: 0 0 4px; }
    .doc-meta { font-size: 0.8rem; color: #94a3b8; margin: 0 0 20px; }
    table { width: 100%; border-collapse: collapse; font-size: 0.9rem; }
    th, td { padding: 10px 14px; text-align: left; border-bottom: 1px solid #e2e8f0; }
    th { background: #f8fafc; font-weight: 600; color: #475569; font-size: 0.8rem; text-transform: uppercase; letter-spacing: 0.04em; }
...
<body>
  <div class="letterhead">
    <p class="letterhead-name">${pharmacyName}</p>
    ${pharmacyMeta ? `<p class="letterhead-meta">${pharmacyMeta}</p>` : ''}
  </div>
  <p class="doc-title">${REPORT_TYPE_LABELS[reportType] || 'Report'}</p>
  <p class="doc-meta">${periodLabel ? `Period: ${periodLabel} &nbsp;·&nbsp; ` : ''}Generated: ${generatedAt}</p>
  ${el.innerHTML}
  ...
  }, [period, startDate, endDate, reportType, pharmacy]);
